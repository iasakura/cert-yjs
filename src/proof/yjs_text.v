...
Proof.
  ...
  { (* loop body: integrate the [j]-th character *)
    ...
    have Hcunit : cell_unit c by (destruct Hnode as (_ & _ & _ & Hcu); exact Hcu).
...
Proof.
  ...
  iAssert (∃ (q : nat) (rem : w64) (cells' : list item_cell) (yt' : yjs.yType.t),
    ...
    with "[t s cur remaining Hparent Hdll Hlk Hclient Hclock Hitemsf Hitemmap Htypesf Htypesmap Hdset Hpendf Hpend Hseq Hhist HtypesAuth Hclose]" as "IH".
  { iExists p, len, ts.(ty_cells), yt0'.
    iFrame "t s Hparent Hdll remaining Hlk Hclient Hclock Hitemsf Hitemmap Htypesf Htypesmap Hdset Hpendf Hpend Hseq Hhist HtypesAuth Hclose".
  ...
  - (* already a tombstone: [Indexable] is false, walk past it unchanged *)
    ...
    iFrame "Htptr Hsp Hparent Hdll Hrem Hlk Hclient Hclock Hitemsf Hitemmap Htypesf Htypesmap Hdset Hpendf Hpend Hseq Hhist HtypesAuth Hclose".
