(** Text handle: [wp_Text__Delete] (tombstoning a visible run) and the
    read-path [wp_Text__Len]. Split out of [yjs_text]; shares [is_Text]
    etc. via [yjs_text_base]. *)
...
From New.proof Require Import yjs_text_base.
